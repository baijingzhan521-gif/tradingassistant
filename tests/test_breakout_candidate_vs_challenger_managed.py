...
from scripts.run_breakout_candidate_vs_challenger_managed import build_comparison_decision
...
def test_build_comparison_decision_candidate_can_challenge_mainline() -> None:
    summary_rows = [
        _summary_row(cost="base", window="full_2020", kind="baseline_managed", geo=30.0, cagr=4.5, pf=1.20, max_dd_r=13.0),
        _summary_row(cost="base", window="full_2020", kind="candidate", geo=32.0, cagr=4.8, pf=1.25, max_dd_r=14.0),
        _summary_row(cost="stress_x2", window="full_2020", kind="baseline_managed", geo=5.0, cagr=0.8, pf=1.05, max_dd_r=15.0),
        _summary_row(cost="stress_x2", window="full_2020", kind="candidate", geo=6.0, cagr=1.0, pf=1.10, max_dd_r=14.0),
    ]
    side_rows = [
...
def test_build_comparison_decision_mainline_still_preferred_when_candidate_fails_guard() -> None:
    summary_rows = [
        _summary_row(cost="base", window="full_2020", kind="baseline_managed", geo=30.0, cagr=4.5, pf=1.20, max_dd_r=13.0),
        _summary_row(cost="base", window="full_2020", kind="candidate", geo=31.0, cagr=4.7, pf=1.25, max_dd_r=14.0),
        _summary_row(cost="stress_x2", window="full_2020", kind="baseline_managed", geo=5.0, cagr=0.8, pf=1.05, max_dd_r=15.0),
        _summary_row(cost="stress_x2", window="full_2020", kind="candidate", geo=-1.0, cagr=-0.2, pf=0.95, max_dd_r=14.0),
    ]
    side_rows = [
        _side_row(cost="base", window="two_year", kind="baseline_managed", side="LONG", cum_r=10.0),
