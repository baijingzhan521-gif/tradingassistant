...
from scripts.run_switch_post_tp1_path_one_rule_gate import (
    BASELINE_PRESET,
    PRESETS,
...
def _build_inputs(
    *,
    ...
    if btc_counts is None:
        btc_counts = {
            BASELINE_PRESET: 2,
            "path_hold_2bars_4h_bullish": 2,
            "path_hold_3bars_4h_bullish": 3,
            "path_hold_3bars_4h_bullish_then_be_on_4h_loss": 1,
        }
...
def test_build_promotion_decision_promotes_and_satisfies_btc_non_regression() -> None:
    winner = "path_hold_3bars_4h_bullish"
    summary_rows, side_rows, concentration_rows, oos_rows, btc_counts = _build_inputs(
        candidate_overrides={
            ...
            "path_hold_2bars_4h_bullish": {"base_geo": 9.0, "base_cagr": 18.8},
            "path_hold_3bars_4h_bullish_then_be_on_4h_loss": {"base_geo": 8.9, "base_cagr": 18.7},
        },
        btc_counts={
            BASELINE_PRESET: 2,
            "path_hold_2bars_4h_bullish": 2,
...
def test_build_promotion_decision_rejects_when_any_m1_gate_fails(override: dict, expected_fail_key: str) -> None:
    target = "path_hold_3bars_4h_bullish"
    per_candidate = {
...
def test_build_btc_yearly_comparison_aggregates_counts() -> None:
    yearly_rows = [
        ...
        },
        {
            "cost_scenario": "base",
            "window": "full_2020",
            "preset": "path_hold_2bars_4h_bullish",
            "year": 2020,
    ...
    assert counts["path_hold_2bars_4h_bullish"] == 1
