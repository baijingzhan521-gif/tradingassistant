...
DEFAULT_CONFIG = {
    **COMMON_DEFAULT_CONFIG,
    ...
    "window": {
        ...
        "bullish_trend_strength_threshold": 90,
        "bearish_trend_strength_threshold": 60,
    },
}


class SwingTrendLongRegimeGateV1Strategy(WindowedMTFStrategy):
    name = "swing_trend_long_regime_gate_v1"
