...
DEFAULT_CONFIG = {
    **SWING_LONG_REGIME_GATE_DEFAULT_CONFIG,
    "position_map": {
        **SWING_LONG_REGIME_GATE_DEFAULT_CONFIG.get("position_map", {}),
...
class SwingTrendAxisBandDiagnosticV1Strategy(WindowedMTFStrategy):
    name = "swing_trend_axis_band_diagnostic_v1"
