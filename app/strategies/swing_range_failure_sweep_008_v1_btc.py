...
DEFAULT_CONFIG["range_failure"]["sweep_buffer_atr"] = 0.08


class SwingRangeFailureSweep008V1BTCStrategy(SwingRangeFailureV1BTCStrategy):
    name = "swing_range_failure_sweep_008_v1_btc"
