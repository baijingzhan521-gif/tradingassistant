...
DEFAULT_OUTPUT_DIR = ROOT / "artifacts" / "backtests" / "exhaustion_candidate_vs_challenger_managed"
DEFAULT_CANDIDATE_PROFILE = "swing_exhaustion_divergence_ct_block80_v1_btc"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Independent pool comparison: exhaustion candidate vs challenger_managed.")
...
def build_report(
    *,
    ...
    return "\n".join(
        [
            "# Exhaustion Candidate vs Challenger Managed",
            "",
...
def main() -> None:
    ...
    print(f"saved exhaustion candidate vs challenger managed artifacts to {output_dir}")
